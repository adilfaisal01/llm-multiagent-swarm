.PHONY: help test test-unit test-pytest test-tools test-skills test-e2e test-ci act clean
...
help:
	...
	@echo "  make test        - all hermetic tests (unit + pytest + tools)"
...
test: test-unit test-pytest test-tools
