...
**Full-pack skills** (`research`, `reverse-engineering`, `fact-check`, `academic`, `legal`, `medical`, `finance`) ship a `team.json` with named workers, models, and angles. Run them with `--skill <name>`:
